...
CREATE INDEX idx_products_country_city_available ON products(country_id, city_id, available);
CREATE INDEX idx_carts_customer_status ON carts(customer_id, status);
CREATE INDEX idx_cart_items_cart ON cart_items(cart_id);
CREATE INDEX idx_drivers_user ON drivers(user_id);
CREATE INDEX idx_drivers_country_city_online ON drivers(country_id, city_id, online, frozen);
...
CREATE INDEX idx_wallet_accounts_user_currency ON wallet_accounts(user_id, currency);
CREATE INDEX idx_payouts_payee_status ON payouts(payee_user_id, status);
CREATE INDEX idx_reviews_order ON reviews(order_id);
CREATE INDEX idx_reviews_reviewer ON reviews(reviewer_user_id);
CREATE INDEX idx_support_tickets_status_priority ON support_tickets(country_id, city_id, status, priority);
...
CREATE INDEX idx_feature_flags_country_city ON feature_flags(country_id, city_id);
